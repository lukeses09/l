...
<?php
    ...
    if(isset($_GET['EMPLOYEEID']))
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            $query3=mysql_query("update existdb.employees set M_STATUS='$m_status',LNAME='$lname',FNAME='$fname',MNAME='$mname',FULLNAME='$fullname',BIRTHDATE='$bdate',GENDER='$gender',NATIONALITY='$nationality',ADDRESS='$address',POSITION='$position',CPHONE='$cphone',TPHONE='$tphone',EMAIL='$email',EMERNAME='$emername',EMERPHONE='$emernum',USERNAME='$r',DEPARTMENT='$department',POSITION='$position' WHERE EMPLOYEEID='$EMPLOYEEID'");
			...
			mysql_query("INSERT INTO existdb.log_trail(LOG_DATE,LOG_TIME,LOG_DET,USER,ACCOUNT_TYPE,DEPARTMENT) VALUES('$DATE','$TIME','Employee Records Editing Success','$username','User Accounts','$userdep')");
                ...
                if($query3)
                {
					...
					echo '{';
					header('location:admin_employee_records.php');
					echo '}';
					echo '</script>';
...
<div id="wrap_edit">
<div id="edit_employee_content">
	<form action="" method="post">
        <h1></h1>
        <table cellpadding="2" cellspacing="0" id="tbl_edit_employee">
			<tr>
				<td id="tdl">Picture:</td>
				<td id="tdr">
					<input name='filename' type='file' id="upload" value="$query2['IMAGE'];">
				</td>
			</tr>
